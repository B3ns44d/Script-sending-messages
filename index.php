...
#########################################################################
#	https://www.linkedin.com/in/abdessamad-bensaad-274428198/        	#
#	https://github.com/bensaad2       						            #
#	All rights by Abdessamad Bensaad                                    #
#-----------------------------------------------------------------------#
#                           				                         	#
#########################################################################
...
<html lang="de-DE">
	<head>
		...
		<meta name="description" content="pro16.herokuapp.com"/>
		<meta name="revisit" content="After 7 days"/>
		<meta name="robots" content="INDEX,FOLLOW"/>
		<title>pro16.herokuapp.com</title>
		<link href="style-contact-form.css" rel="stylesheet" type="text/css" />
		<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />
	</head>
	<body id="bensaadseite">
		<form class="bensaad" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data">
			...
			<input type="hidden" name="content" value="formular"/>
				...
				<div class="row column-2">
                    <div>
    					...
    					<div class="field">
    						<?php if ($fehler["name"] != "") { echo $fehler["name"]; } ?><input type="text" name="name" maxlength="50" value="<?php echo $_POST[name]; ?>"  <?php if ($fehler["name"] != "") { echo 'class="errordesignfields"'; } ?>/>
				...
				<div class="row column-2">
				 ...
				 <div class="row">
					...
					<div class="field">
						<?php if ($fehler["subject"] != "") { echo $fehler["subject"]; } ?><input type="text" name="subject" style="width:100%;" maxlength="50" value="<?php echo $_POST[subject]; ?>"  <?php if ($fehler["subject"] != "") { echo 'class="errordesignfields"'; } ?>/>
			...
			if(0<$cfg['NUM_ATTACHMENT_FIELDS']){
				echo '<div class="row">';
					echo '<label>Attachment: <span class="pflichtfeld">*</span></label>';
				echo '<div>';
				  for ($i=0; $i < $cfg['NUM_ATTACHMENT_FIELDS']; $i++) {
					  echo '<div><div class="field"><input type="file" style="margin-top:10px;" size="12" name="f[]" /></div></div>';
				  }
...
?>
			   ...
			   <div class="pflichtfeldhinweis"><br /><b>Advice:</b> Fields with <span class="pflichtfeld">*</span> have to be filled.</div>
			   <div class="buttons"><br /><input type="submit" name="mt-mk" value="Send" style="width:100%;font-size:14px;" onclick="tescht();"/>
			  </div>


<div class="copyright"><!-- It´s not allowed to remove the copyright notice! --><br /><br /><strong><a href="https://www.pro16.herokuapp.com/en" title="Contact Form">Contact Form</a></strong>: <a href="https://www.pro16.herokuapp.com/en">&copy; pro16.herokuapp.com</a></div>
		</form>
	</body>
</html>
